package org.iris_events.manager.queue.model;

import java.util.List;
import java.util.Map;

import com.rabbitmq.client.Envelope;
import org.iris_events.manager.queue.operations.MessageMoveOperation;
import org.iris_events.manager.queue.operations.MessageRequeueOperation;
...
public class Message {
    ...
    public int getRequeueCount() {
        return getCount(MessageRequeueOperation.REQUEUE_COUNT_HEADER);
    }
    ...
    public int getMovedCount() {
        return getCount(MessageMoveOperation.MOVE_COUNT_HEADER);
    }
